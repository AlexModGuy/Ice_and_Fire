 ...
 */
public class FlexibleAdvancedPathNavigate extends AbstractAdvancedPathNavigate {
     ...
     */
    public FlexibleAdvancedPathNavigate(final MobEntity entity, final World world) {
        this(entity,world,MovementType.WALKING);
    }
    public FlexibleAdvancedPathNavigate(final MobEntity entity, final World world, MovementType type) {
       this(entity, world, type,1,1);
    }
    public FlexibleAdvancedPathNavigate(final MobEntity entity, final World world, MovementType type,float width,float height) {
        super(entity, world);
        switch (type){
            case FLYING:
