...
public class DummyPiece extends TemplateStructurePiece {
    ...
    private void loadTemplate(TemplateManager p_204754_1_) {
        Template lvt_2_1_ = p_204754_1_.getOrCreate(new ResourceLocation("minecraft:empty"));
        PlacementSettings lvt_3_1_ = (new PlacementSettings()).setRotation(Rotation.CLOCKWISE_90).setMirror(Mirror.NONE).setRotationPivot(new BlockPos(0, 0, 0)).addProcessor(BlockIgnoreStructureProcessor.STRUCTURE_AND_AIR);
