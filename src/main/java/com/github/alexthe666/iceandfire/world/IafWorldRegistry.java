...
public class IafWorldRegistry {
    ...
    public static void register() {
        ...
        GRAVEYARD = Registry.register(Registry.FEATURE, "iceandfire:graveyard", GRAVEYARD);
        Registry.register(Registry.STRUCTURE_FEATURE, "iceandfire:graveyard", GRAVEYARD);
        ...
        for (Biome biome : ForgeRegistries.BIOMES) {
            if (BiomeDictionary.hasType(biome, BiomeDictionary.Type.OVERWORLD)) {
                ...
                if (!BiomeDictionary.hasType(biome, BiomeDictionary.Type.OCEAN) && !BiomeDictionary.hasType(biome, BiomeDictionary.Type.WATER) && !BiomeDictionary.hasType(biome, BiomeDictionary.Type.BEACH)) {
                    ...
                    biome.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, GRAVEYARD.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).withPlacement(Placement.NOPE.configure(IPlacementConfig.NO_PLACEMENT_CONFIG)));
                }
            }
