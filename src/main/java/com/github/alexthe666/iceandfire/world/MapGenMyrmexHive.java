...
public class MapGenMyrmexHive extends WorldGenerator {
	private final int minTownSeparation;
	private int size;
	private int distance;

	public MapGenMyrmexHive() {
		this.distance = 9;
		this.minTownSeparation = 8;
	}

	public MapGenMyrmexHive(Map<String, String> map) {
		this();
	...
	protected StructureStart getStructureStart(World world, int chunkX, int chunkZ, Random random) {
		return new MapGenMyrmexHive.Start(world, random, chunkX, chunkZ, this.size);
	}
