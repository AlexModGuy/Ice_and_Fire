...
public class CommonProxy {
    ...
    public static void registerEntities(RegistryEvent.Register<EntityEntry> event) {
        ...
        registerSpawnable(EntityEntryBuilder.<EntityBlackFrostDragon>create(), event, EntityBlackFrostDragon.class, "black_frost_dragon", 52, 0XE0E6E6, 0X000000);
        registerSpawnable(EntityEntryBuilder.<EntityDreadQueen>create(), event, EntityDreadQueen.class, "dread_queen", 53, 0X446B8A, 0X00FFFF);
    }
