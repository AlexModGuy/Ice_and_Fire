...
public class IafItemRegistry {
    ...
    public static final Item DRAGONARMOR_IRON_0 = new ItemDragonArmor(0, 0, "dragonarmor_iron");
    public static final Item DRAGONARMOR_IRON_1 = new ItemDragonArmor(0, 1, "dragonarmor_iron");
    public static final Item DRAGONARMOR_IRON_2 = new ItemDragonArmor(0, 2, "dragonarmor_iron");
    public static final Item DRAGONARMOR_IRON_3 = new ItemDragonArmor(0,3, "dragonarmor_iron");
    public static final Item DRAGONARMOR_GOLD_0 = new ItemDragonArmor(1, 0,"dragonarmor_gold");
    public static final Item DRAGONARMOR_GOLD_1 = new ItemDragonArmor(1, 1, "dragonarmor_gold");
    public static final Item DRAGONARMOR_GOLD_2 = new ItemDragonArmor(1, 2, "dragonarmor_gold");
    public static final Item DRAGONARMOR_GOLD_3 = new ItemDragonArmor(1, 3, "dragonarmor_gold");
    public static final Item DRAGONARMOR_DIAMOND_0 = new ItemDragonArmor(2, 0,"dragonarmor_diamond");
    public static final Item DRAGONARMOR_DIAMOND_1 = new ItemDragonArmor(2, 1,"dragonarmor_diamond");
    public static final Item DRAGONARMOR_DIAMOND_2 = new ItemDragonArmor(2, 2,"dragonarmor_diamond");
    public static final Item DRAGONARMOR_DIAMOND_3 = new ItemDragonArmor(2, 3,"dragonarmor_diamond");
    public static final Item DRAGONARMOR_SILVER_0 = new ItemDragonArmor(3, 0, "dragonarmor_silver");
    public static final Item DRAGONARMOR_SILVER_1 = new ItemDragonArmor(3, 1, "dragonarmor_silver");
    public static final Item DRAGONARMOR_SILVER_2 = new ItemDragonArmor(3, 2, "dragonarmor_silver");
    public static final Item DRAGONARMOR_SILVER_3 = new ItemDragonArmor(3, 3, "dragonarmor_silver");
    public static final Item DRAGONARMOR_DRAGONSTEEL_FIRE_0 = new ItemDragonArmor(4, 0, "dragonarmor_dragonsteel_fire");
    public static final Item DRAGONARMOR_DRAGONSTEEL_FIRE_1 = new ItemDragonArmor(4, 1, "dragonarmor_dragonsteel_fire");
    public static final Item DRAGONARMOR_DRAGONSTEEL_FIRE_2 = new ItemDragonArmor(4, 2, "dragonarmor_dragonsteel_fire");
    public static final Item DRAGONARMOR_DRAGONSTEEL_FIRE_3 = new ItemDragonArmor(4, 3, "dragonarmor_dragonsteel_fire");
    public static final Item DRAGONARMOR_DRAGONSTEEL_ICE_0 = new ItemDragonArmor(5, 0, "dragonarmor_dragonsteel_ice");
    public static final Item DRAGONARMOR_DRAGONSTEEL_ICE_1 = new ItemDragonArmor(5, 1, "dragonarmor_dragonsteel_ice");
    public static final Item DRAGONARMOR_DRAGONSTEEL_ICE_2 = new ItemDragonArmor(5, 2, "dragonarmor_dragonsteel_ice");
    public static final Item DRAGONARMOR_DRAGONSTEEL_ICE_3 = new ItemDragonArmor(5, 3, "dragonarmor_dragonsteel_ice");
