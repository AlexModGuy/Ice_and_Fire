...
public class IafItemRegistry {
    ...
    public static final Item DRAGONSTEEL_FIRE_SWORD = new ItemModSword(DRAGONSTEEL_TIER_FIRE, "dragonsteel_fire_sword");
    public static final Item DRAGONSTEEL_FIRE_PICKAXE = new ItemModPickaxe(DRAGONSTEEL_TIER_FIRE, "dragonsteel_fire_pickaxe");
    public static final Item DRAGONSTEEL_FIRE_AXE = new ItemModAxe(DRAGONSTEEL_TIER_FIRE, "dragonsteel_fire_axe");
    public static final Item DRAGONSTEEL_FIRE_SHOVEL = new ItemModShovel(DRAGONSTEEL_TIER_FIRE, "dragonsteel_fire_shovel");
    public static final Item DRAGONSTEEL_FIRE_HOE = new ItemModHoe(DRAGONSTEEL_TIER_FIRE, "dragonsteel_fire_hoe");
    ...
    public static final Item DRAGONSTEEL_ICE_SWORD = new ItemModSword(DRAGONSTEEL_TIER_ICE, "dragonsteel_ice_sword");
    public static final Item DRAGONSTEEL_ICE_PICKAXE = new ItemModPickaxe(DRAGONSTEEL_TIER_ICE, "dragonsteel_ice_pickaxe");
    public static final Item DRAGONSTEEL_ICE_AXE = new ItemModAxe(DRAGONSTEEL_TIER_ICE, "dragonsteel_ice_axe");
    public static final Item DRAGONSTEEL_ICE_SHOVEL = new ItemModShovel(DRAGONSTEEL_TIER_ICE, "dragonsteel_ice_shovel");
    public static final Item DRAGONSTEEL_ICE_HOE = new ItemModHoe(DRAGONSTEEL_TIER_ICE, "dragonsteel_ice_hoe");
    ...
    public static final Item DRAGONSTEEL_LIGHTNING_SWORD = new ItemModSword(DRAGONSTEEL_TIER_LIGHTNING, "dragonsteel_lightning_sword");
    public static final Item DRAGONSTEEL_LIGHTNING_PICKAXE = new ItemModPickaxe(DRAGONSTEEL_TIER_LIGHTNING, "dragonsteel_lightning_pickaxe");
    public static final Item DRAGONSTEEL_LIGHTNING_AXE = new ItemModAxe(DRAGONSTEEL_TIER_LIGHTNING, "dragonsteel_lightning_axe");
    public static final Item DRAGONSTEEL_LIGHTNING_SHOVEL = new ItemModShovel(DRAGONSTEEL_TIER_LIGHTNING, "dragonsteel_lightning_shovel");
    public static final Item DRAGONSTEEL_LIGHTNING_HOE = new ItemModHoe(DRAGONSTEEL_TIER_LIGHTNING, "dragonsteel_lightning_hoe");
    ...
    public static final Item DREAD_QUEEN_SWORD = new ItemModSword(DRAGONSTEEL_TIER_DREAD_QUEEN, "dread_queen_sword");
