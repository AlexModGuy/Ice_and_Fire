...
public class ItemHippocampusSlapper extends SwordItem {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new TranslationTextComponent("item.iceandfire.hippocampus_slapper.desc_0").applyTextStyle(TextFormatting.GRAY));
        tooltip.add(new TranslationTextComponent("item.iceandfire.hippocampus_slapper.desc_1").applyTextStyle(TextFormatting.GRAY));
    }
}