...
public class ItemTideTrident extends TridentItem {
                ...
                if (lvt_7_1_ <= 0 || lvt_5_1_.isWet()) {
                    if (!worldIn.isRemote) {
                        ...
                        if (lvt_7_1_ == 0) {
                            ...
                            worldIn.playMovingSound(null, lvt_8_1_, SoundEvents.ITEM_TRIDENT_THROW, SoundCategory.PLAYERS, 1.0F, 1.0F);
                            if (!lvt_5_1_.abilities.isCreativeMode) {
                    ...
                    if (lvt_7_1_ > 0) {
                        ...
                        worldIn.playMovingSound(null, lvt_5_1_, lvt_15_4_, SoundCategory.PLAYERS, 1.0F, 1.0F);
                    }
    ...
    public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType equipmentSlot) {
        ...
        if (equipmentSlot == EquipmentSlotType.MAINHAND) {
            builder.put(Attributes.ATTACK_DAMAGE, new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Weapon modifier", 12.0D, AttributeModifier.Operation.ADDITION));
            builder.put(Attributes.ATTACK_SPEED, new AttributeModifier(ATTACK_SPEED_MODIFIER, "Weapon modifier", -2.9F, AttributeModifier.Operation.ADDITION));
        }
