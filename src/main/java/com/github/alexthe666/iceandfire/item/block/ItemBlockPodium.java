...
public class ItemBlockPodium extends ItemBlock {
	...
	public ModelResourceLocation getModel(ItemStack stack, EntityPlayer player, int useRemaining)
	{
		...
		default:
			return new ModelResourceLocation("iceandfire:podium_oak", "inventory");
		case 1:
			return new ModelResourceLocation("iceandfire:podium_spruce", "inventory");	
		case 2:
			return new ModelResourceLocation("iceandfire:podium_birch", "inventory");	
		case 3:
			return new ModelResourceLocation("iceandfire:podium_jungle", "inventory");	
		case 4:
			return new ModelResourceLocation("iceandfire:podium_acacia", "inventory");	
		case 5:
