...
public class ItemAmphithereMacuahuitl extends SwordItem {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new TranslationTextComponent("item.iceandfire.amphithere_macuahuitl.desc_0").func_240699_a_(TextFormatting.GRAY));
        tooltip.add(new TranslationTextComponent("item.iceandfire.amphithere_macuahuitl.desc_1").func_240699_a_(TextFormatting.GRAY));
    }
}
