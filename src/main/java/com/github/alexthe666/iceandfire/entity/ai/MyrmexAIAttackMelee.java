...
public class MyrmexAIAttackMelee extends Goal {
    ...
    private FlexibleAdvancedPathNavigate pathNavigate;
    ...
    public boolean shouldExecute() {
        ...
        if (this.myrmex.getNavigator() instanceof FlexibleAdvancedPathNavigate) {
            pathNavigate = (FlexibleAdvancedPathNavigate) this.myrmex.getNavigator();
        } else {
            return false;
        }
        if (LivingEntity == null) {
            ...
            attackPath = ((FlexibleAdvancedPathNavigate) this.myrmex.getNavigator()).moveToLivingEntity(LivingEntity, speedTowardsTarget);
    ...
    public boolean shouldContinueExecuting() {
        LivingEntity LivingEntity = this.myrmex.getAttackTarget();
        if (LivingEntity != null && !LivingEntity.isAlive() || !(this.myrmex.getNavigator() instanceof FlexibleAdvancedPathNavigate)) {
            this.resetTask();
            return false;
        }
    ...
    public void tick() {
        ...
        ((FlexibleAdvancedPathNavigate) this.myrmex.getNavigator()).tryMoveToEntityLiving(entity, speedTowardsTarget);
        if (entity != null) {
