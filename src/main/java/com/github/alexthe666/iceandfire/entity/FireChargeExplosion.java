...
public class FireChargeExplosion extends Explosion {
    ...
    public void doExplosionB(boolean spawnParticles) {
        ...
        if (this.explosionSize >= 2.0F && this.isSmoking) {
            this.worldObj.spawnParticle(ParticleTypes.EXPLOSION_HUGE, this.explosionX, this.explosionY, this.explosionZ, 1.0D, 0.0D, 0.0D);
        } else {
            this.worldObj.spawnParticle(ParticleTypes.EXPLOSION_LARGE, this.explosionX, this.explosionY, this.explosionZ, 1.0D, 0.0D, 0.0D);
        }
        ...
        if (this.isSmoking) {
            for (BlockPos blockpos : this.affectedBlockPositions) {
                ...
                if (spawnParticles) {
                    ...
                    d4 = d4 * d7;
                    d5 = d5 * d7;
                    this.worldObj.spawnParticle(ParticleTypes.EXPLOSION_NORMAL, (d0 + this.explosionX) / 2.0D, (d1 + this.explosionY) / 2.0D, (d2 + this.explosionZ) / 2.0D, d3, d4, d5);
