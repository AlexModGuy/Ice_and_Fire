        ...
        if (this.world.isRemote || (shootingEntity == null || !shootingEntity.isAlive()) && this.world.isBlockLoaded(this.getPosition())) {
            if (this.world.isRemote || (shootingEntity == null || !shootingEntity.removed) && this.world.isBlockLoaded(this.getPosition())) {
                ...
                if (this.world.isRemote) {
                    for (int i = 0; i < 3; ++i) {
                        IceAndFire.PROXY.spawnParticle("serpent_bubble", this.getPosX() + this.rand.nextFloat() * this.getWidth() - (double) this.getWidth() * 0.5F, this.getPosY() - 0.5D, this.getPosZ() + this.rand.nextFloat() * this.getWidth() - (double) this.getWidth() * 0.5F, 0, 0, 0);
                    }
                }
