...
public class MyrmexTrades {
    ...
    static {
        DESERT_WORKER = createTrades(ImmutableMap.of(1,
                new VillagerTrades.ITrade[]{
                        new ItemsForDesertResinTrade(Items.BONE, 3, 8, 9, 1),
                },
                //Only 3 of these appears per myrmex
                2, new VillagerTrades.ITrade[]{
                        new ItemsForDesertResinTrade(Items.STICK, 1, 1, 5, 2),
                }));
    ...
    static class ItemsForDesertResinTrade implements VillagerTrades.ITrade {
        ...
        public MerchantOffer getOffer(Entity p_221182_1_, Random p_221182_2_) {
            return new MerchantOffer(new ItemStack(IafItemRegistry.MYRMEX_DESERT_RESIN, this.emeraldCount), new ItemStack(this.stack.getItem(), this.itemCount), this.maxUses, this.exp, this.multiplier);
        }
    }
