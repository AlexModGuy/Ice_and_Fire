    ...
    protected void spawnDeathParticles() {
        if (this.world.isRemote) {
            for (int k = 0; k < 10; ++k) {
                ...
                IceAndFire.PROXY.spawnParticle("snowflake", this.getPosX() + this.rand.nextFloat() * this.getWidth() * 2.0F - this.getWidth(), this.getPosY() + this.rand.nextFloat() * this.getHeight(), this.getPosZ() + this.rand.nextFloat() * this.getWidth() * 2.0F - this.getWidth(), d2, d0, d1);
            }
        }
    }
