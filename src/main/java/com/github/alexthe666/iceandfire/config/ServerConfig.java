...
public class ServerConfig {
    ...
    public ServerConfig(final ForgeConfigSpec.Builder builder) {
        ...
        this.trollSpawnCheckChance = buildInt(builder, "Troll Spawn Check Chance", "all", 10, 1, 10000, "A double check to see if the game can spawn trolls. Higher number = lower chance to spawn.");
