...
public class ServerConfig {
    ...
    public final ForgeConfigSpec.IntValue dragonHealth;
    ...
    public ServerConfig(final ForgeConfigSpec.Builder builder) {
        ...
        this.dragonHealth = buildInt(builder, "Dragon Health", "all", 500, 1, 100000, "Max dragon health. Health is scaled to this");
        ...
        this.hippocampusSpawnChance = buildInt(builder, "Spawn Hippocampus Chance", "all", 70, 1, 10000, "1 out of this number chance per chunk for generation");
        ...
        this.deathWormSpawnRate = buildInt(builder, "Death Worm Spawn Weight", "all", 2, 1, 10000, "Deathworm spawn weight. Lower = lower chance to spawn");
        ...
        this.trollSpawnCheckChance = buildInt(builder, "Troll Spawn Check Chance", "all", 1, 1, 10000, "A double check to see if the game can spawn trolls. Higher number = lower chance to spawn.");
        ...
        this.dangerousWorldGenDistanceLimit = buildInt(builder, "Dangerous World Gen Dist From Spawn", "all", 300, 1, 10000, "How far away dangerous structures(dragon roosts, cyclops caves, etc.) must be from spawn(0, 0).");
    }
