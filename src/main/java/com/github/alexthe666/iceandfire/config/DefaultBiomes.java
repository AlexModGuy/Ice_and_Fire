...
public class DefaultBiomes {
    ...
    public static final String[] VERY_SNOWY = new String[] { "&#overworld+&#snowy+|@icy+|#cold+" };
    public static final String[] SNOWY = new String[] { "&#overworld+|#snowy+|#cold" };
    ...
    public static final String[] SWAMPS = new String[] { "&#overworld+|@swamp+|#swamp+" };
