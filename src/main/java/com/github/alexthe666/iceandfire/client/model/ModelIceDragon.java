...
public class ModelIceDragon extends ModelDragonBase {
	...
	public ModelAnimator animator;
		...
		public ModelIceDragon() {
			...
			this.setRotateAngle(TailFin2, 0.0F, -0.7853981633974483F, 0.0F);
			this.TailFin1 = new AdvancedModelRenderer(this, 40, 87);
			this.TailFin1.setRotationPoint(0.0F, 0.0F, 0.0F);
			this.TailFin1.addBox(0.0F, -0.1F, 1.31F, 9, 0, 12, 0.0F);
			this.setRotateAngle(TailFin1, 0.0F, -0.7853981633974483F, 3.141592653589793F);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
		...
		progressRotation(TailFin1, dragon.swimProgress, 0, -((float)Math.toRadians(45.0D)), (float)Math.toRadians(180.0D));
		...
		progressRotation(TailFin2, dragon.swimProgress, 0, -((float)Math.toRadians(45.0D)), 0);
