...
public class ModelDragonsteelIceArmor extends BipedModel {
    ...
    public ModelDragonsteelIceArmor(float modelSize) {
        ...
        this.HornL7 = new ModelRenderer(this, 25, 45);
        this.HornL7.setRotationPoint(0.0F, 0.0F, 4.3F);
        ...
        this.HornR6 = new ModelRenderer(this, 9, 38);
        this.HornR6.mirror = true;
        this.HornR6.setRotationPoint(-1.1F, -7.6F, -4.0F);
        ...
        this.HornR7 = new ModelRenderer(this, 25, 45);
        this.HornR7.mirror = true;
        this.HornR7.setRotationPoint(0.0F, 0.0F, 4.3F);
        ...
        this.HornL6 = new ModelRenderer(this, 9, 38);
        this.HornL6.setRotationPoint(1.1F, -7.6F, -4.0F);
        ...
        this.bipedHead.addChild(this.HornR6);
        ...
        this.bipedHead.addChild(this.HornL6);
