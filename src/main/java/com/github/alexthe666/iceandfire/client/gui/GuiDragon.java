...
public class GuiDragon extends AbstractContainerScreen<ContainerDragon> {
    ...
    protected void renderBg(@NotNull PoseStack matrixStack, float partialTicks, int mouseX, int mouseY) {
        ...
        if (entity instanceof EntityDragonBase) {
            ...
            InventoryScreen.renderEntityInInventoryRaw(k + 88, l + (int) (0.5F * (dragon.flyProgress)) + 55, (int) (dragonScale * 23F), quaternionf, null, dragon);
        }
        if (entity instanceof EntityDragonBase) {
            EntityDragonBase dragon = (EntityDragonBase) entity;
            ...
            font.drawInBatch(s2, k + this.imageWidth / 2 - font.width(s2) / 2, l + 84, 0XFFFFFF, false, matrixStack.last().pose(), bufferSource, false, 0, 15728880);
            ...
            font.drawInBatch(s5, k + this.imageWidth / 2 - font.width(s5) / 2, l + 93, 0XFFFFFF, false, matrixStack.last().pose(), bufferSource, false, 0, 15728880);
            String s6 = StatCollector.translateToLocal("dragon.hunger") + dragon.getHunger() + "/100";
            font.drawInBatch(s6, k + this.imageWidth / 2 - font.width(s6) / 2, l + 102, 0XFFFFFF, false, matrixStack.last().pose(), bufferSource, false, 0, 15728880);
            ...
            font.drawInBatch(s4, k + this.imageWidth / 2 - font.width(s4) / 2, l + 111, 0XFFFFFF, false, matrixStack.last().pose(), bufferSource, false, 0, 15728880);
            ...
            font.drawInBatch(s7, k + this.imageWidth / 2 - font.width(s7) / 2, l + 120, 0XFFFFFF, false, matrixStack.last().pose(), bufferSource, false, 0, 15728880);
        }
    }
