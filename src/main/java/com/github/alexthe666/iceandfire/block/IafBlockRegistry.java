...
public class IafBlockRegistry {
    ...
    public static final Block CRACKLED_GRASS = new BlockReturningState(Material.PLANTS, "crackled_grass", "shovel", 0, 0.6F, 0.0F, SoundType.GROUND, Blocks.GRASS.getDefaultState());
